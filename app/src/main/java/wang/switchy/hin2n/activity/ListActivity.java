                            ...
                            .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                                ...
                                public void onClick(SweetAlertDialog sweetAlertDialog) {
                                    ...
                                    if (currentSettingId != -1) {
                                        N2NSettingModel currentSettingItem = Application.getInstance().getDaoSession().getN2NSettingModelDao().load((long) currentSettingId);
                                        if (currentSettingItem != null) {
                                            currentSettingItem.setIsSelcected(false);
                                            Application.getInstance().getDaoSession().getN2NSettingModelDao().update(currentSettingItem);
                                        }
                                    }
                ...
                switch (index) {
                    case 0:
                        ...
                        N2NSettingModel n2NSettingModel = new N2NSettingModel(null, n2NSettingModelCopy.getVersion(), copyName, n2NSettingModelCopy.getIp(), n2NSettingModelCopy.getNetmask(), n2NSettingModelCopy.getCommunity(),
                                ...
                                n2NSettingModelCopy.isUseHttpTunnel(), n2NSettingModelCopy.getTraceLevel(), false,n2NSettingModelCopy.getDeviceID(),n2NSettingModelCopy.getDeviceIP(),n2NSettingModelCopy.getUsername());
