...
public class SettingDetailsActivity extends BaseActivity implements View.OnClickListener {
    ...
    private TextInputLayout mUserame;
    ...
    private ImageView mDevice_id_qr;
    private String TAG = "SettingDetailsActivity";
    @Override
    ...
    protected void doOnCreate(Bundle savedInstanceState) {
        ...
        mUserame = (TextInputLayout) findViewById(R.id.til_user_name);
        ...
        mDevice_id_qr = (ImageView) findViewById(R.id.device_id_qr);
        ...
        if (type == TYPE_SETTING_ADD) {
            ...
            mN2NSettingModel = Application.getInstance().getDaoSession().getN2NSettingModelDao().load(mSaveId);
            mSettingName.getEditText().setText(mN2NSettingModel.getName());
            mUserame.getEditText().setText(mN2NSettingModel.getUsername());
            ...
            String device_id = mN2NSettingModel.getDeviceID();
            if(device_id != null) {
                QRGEncoder qrgEncoder = new QRGEncoder(device_id, null, QRGContents.Type.TEXT, 400);

                try {
                    mDevice_id_qr.setImageBitmap(qrgEncoder.encodeAsBitmap());
                }catch(WriterException e) {
                    Log.e(TAG,e.getMessage());
                }
            }else {
                mDevice_id_qr.setImageBitmap(null);
            }
        }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btn_save:
                ...
                String username = mUserame.getEditText().getText().toString();
                ...
                mN2NSettingModel = new N2NSettingModel(null, getN2nVersion(), settingName,
                        ...
                        mTraceLevelSpinner.getSelectedItemPosition(), !hasSelected,null,null,username);
            ...
            case R.id.btn_modify:
                ...
                N2NSettingModelDao n2NSettingModelDao1 = Application.getInstance().getDaoSession().getN2NSettingModelDao();
                String settingName1 = mSettingName.getEditText().getText().toString();
                String usernamel = mUserame.getEditText().getText().toString();
                ...
                mN2NSettingModel = new N2NSettingModel(mSaveId, getN2nVersion(), settingName1,
                        ...
                        Integer.valueOf(mLocalPort.getEditText().getText().toString()), mAllowRoutinCheckBox.isChecked(),
                        !mAcceptMuticastCheckBox.isChecked(), mUseHttpTunnelCheckBox.isChecked(),
                        mTraceLevelSpinner.getSelectedItemPosition(), mN2NSettingModel.getIsSelcected(),mN2NSettingModel.getDeviceID(),mN2NSettingModel.getDeviceIP(),usernamel);
                Log.d(TAG,"username="+usernamel);
