    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(AddDevicesActivity.this, ScanQRActivity.class);
                        ...
                        if(bundle != null)
                        {
                            ...
                            if (responseText != null) {
                                try {
                                    ...
                                    new SweetAlertDialog(AddDevicesActivity.this, SweetAlertDialog.SUCCESS_TYPE)
                                    ...
                                    new SweetAlertDialog(AddDevicesActivity.this,SweetAlertDialog.ERROR_TYPE)
