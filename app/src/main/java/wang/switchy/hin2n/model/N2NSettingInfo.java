...
public class N2NSettingInfo implements Parcelable {
    ...
    public N2NSettingInfo(N2NSettingModel n2NSettingModel) {
        ...
        this.deviceID = n2NSettingModel.getDeviceID();
        this.deviceIP = n2NSettingModel.getDeviceIP();
        this.username = n2NSettingModel.getUsername();
    }
    ...
    public String getLocalIP() {
        return localIP.endsWith("0.0.0.0")?"dhcp:0.0.0.0":localIP;
    }
