...
public class EdgeCmd {
    ...
    public EdgeCmd(int edgeType, String ipAddr, String ipNetmask, String[] supernodes, String community,
        ...
        this.ipAddr = ipAddr;//"dhcp:0.0.0.0";
    ...
    public EdgeCmd(N2NSettingInfo n2NSettingInfo, int vpnFd, String logPath){
        ...
        this.ipAddr = n2NSettingInfo.getIp();//"dhcp:0.0.0.0";
    ...
    public static boolean checkIPV4(String ip) {
        if(ip!=null && ip.equals("dhcp:0.0.0.0")) {
            return true;
        }
    ...
    public static void getExecute(String commandline) throws Exception {
        try{
