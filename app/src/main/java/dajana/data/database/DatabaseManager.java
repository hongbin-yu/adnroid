...
import dajana.data.database.sqlite.DatabaseTable;
...
public class DatabaseManager extends SQLiteOpenHelper { // implements
    ...
    private static final String DATABASE_NAME = "dajana.db";
    ...
    public void addTables() {
          addTable(FileTable.getInstance());
